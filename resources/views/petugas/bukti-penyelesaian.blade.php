...
@section('title', 'Bukti Penyelesaian Tugas - SiResik')
...
<div class="p-6 lg:p-8">
    ...
    <div class="mb-8 flex items-start justify-between flex-wrap gap-4">
        <div>
            ...
            <h1 class="mt-2 text-3xl font-black text-slate-950">Bukti Penyelesaian Tugas</h1>
            <p class="mt-1 text-sm text-slate-500">Unggah foto sebagai bukti bahwa penjemputan telah diselesaikan.</p>
        </div>
        <a href="{{ route('petugas.riwayat') }}"
           class="rounded-full border border-slate-300 px-5 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-100 transition">
            ← Riwayat Tugas
        </a>
    </div>
