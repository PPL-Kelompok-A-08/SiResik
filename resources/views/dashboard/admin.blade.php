...
<body>
    ...
    <aside id="admin-sidebar">
        ...
        <div style="padding:20px 20px 14px;flex-shrink:0;position:relative;z-index:1;">
            <div style="display:flex;align-items:center;gap:10px;">
                <div
                    style="width:38px;height:38px;border-radius:11px;background:rgba(255,255,255,.12);display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0;">
                    ♻</div>
                <div>
                    <p
                        style="font-size:18px;font-weight:900;letter-spacing:-0.5px;color:#fff;line-height:1.1;margin:0;">
                        SiResik</p>
                    <p
                        style="font-size:8px;letter-spacing:.18em;text-transform:uppercase;color:rgba(167,243,208,.65);margin:2px 0 0;">
                        Sistem Informasi Resik</p>
                </div>
            </div>
            {{-- Mode Supervisi --}}
            <div style="margin-top:14px;">
                <p
                    style="font-size:8px;font-weight:800;letter-spacing:.2em;text-transform:uppercase;color:rgba(167,243,208,.55);margin:0 0 6px;">
                    Mode Supervisi</p>
                <div
                    style="display:flex;align-items:center;justify-content:space-between;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.1);border-radius:10px;padding:8px 12px;">
        ...
        <div style="padding:12px 16px 16px;flex-shrink:0;position:relative;z-index:1;">
            ...
            <div
                style="background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.1);border-radius:14px;padding:10px 12px;display:flex;align-items:center;gap:10px;">
                <div
                    style="width:34px;height:34px;border-radius:50%;background:linear-gradient(135deg,#34d399,#059669);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:900;color:#fff;flex-shrink:0;">
                    {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                </div>
                <div style="min-width:0;">
                    <p
                        style="font-size:12px;font-weight:700;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin:0;">
                        {{ $user->name }}</p>
                    <p
                        style="font-size:8px;letter-spacing:.15em;text-transform:uppercase;color:rgba(167,243,208,.65);margin:2px 0 0;">
                        Super Admin</p>
                </div>
            </div>
        </div>
    ...
    <div id="admin-mobile-bar"
        style="position:fixed;top:0;left:0;right:0;z-index:50;display:none;align-items:center;gap:12px;padding:10px 16px;background:#065f46;box-shadow:0 2px 12px rgba(0,0,0,.2);">
        <button onclick="toggleAdminSidebar()"
            style="color:#fff;background:rgba(255,255,255,.15);border:none;border-radius:8px;padding:7px;cursor:pointer;">
            <i class="fas fa-bars" style="font-size:16px;"></i>
        </button>
        <span style="font-size:16px;font-weight:900;color:#fff;">SiResik Admin</span>
    </div>
    <div id="admin-overlay" onclick="toggleAdminSidebar()"
        style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:49;"></div>
    ...
    <div id="admin-content-wrap">
        <div id="admin-content-inner">
            <main style="padding:24px 28px;">
                ...
                <div id="page-dashboard" class="page active">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="mt-1 text-slate-500">Monitor waste management performance and user participation.
                            </p>
                        </div>
                        <a onclick="showPage('laporan')"
                            class="cursor-pointer rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-bold text-emerald-700 hover:bg-emerald-100">Laporan
                            Periodik</a>
                    </div>
                    ...
                    <div class="mb-5 grid grid-cols-2 gap-3 lg:grid-cols-4">
                        <div class="stat-card"
                            style="background:#fff;border:1px solid #e2e8f0;border-left:3px solid #10b981;">
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">Total Reports
                                </p>
                        ...
                        <div class="stat-card"
                            style="background:#fff;border:1px solid #e2e8f0;border-left:3px solid #3b82f6;">
                            <div>
                        ...
                        <div class="stat-card"
                            style="background:#fff;border:1px solid #e2e8f0;border-left:3px solid #8b5cf6;">
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">Total Officers
                                </p>
                        ...
                        <div class="stat-card"
                            style="background:#fff;border:1px solid #e2e8f0;border-left:3px solid #f59e0b;">
                            <div>
                    ...
                    <div class="mb-5 grid grid-cols-2 gap-3 lg:grid-cols-3">
                        ...
                        <div class="stat-card stat-card-plain col-span-2 lg:col-span-1">
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Registered Users
                                </p>
                    ...
                    <div class="section-card p-6 mb-6">
                        <div class="mb-4 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
                            ...
                            <span class="text-sm font-semibold text-slate-500">{{ $periodicSummary['total'] }} reports
                                matched</span>
                        </div>
                        <form method="GET" action="{{ route('dashboard.admin') }}"
                            class="grid grid-cols-1 gap-3 lg:grid-cols-[1fr,1fr,1fr,auto] lg:items-end">
                            <input type="hidden" name="section" value="laporan">
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Periode
                                    Mulai</label>
                                <input type="date" name="report_start" value="{{ $reportFilters['start'] }}"
                            ...
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Periode
                                    Akhir</label>
                                <input type="date" name="report_end" value="{{ $reportFilters['end'] }}"
                                    class="w-full border border-slate-300 rounded-lg px-3 py-2">
                            </div>
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Status</label>
                                <select name="report_status"
                                    class="w-full border border-slate-300 rounded-lg px-3 py-2">
                                    <option value="all" @selected($reportFilters['status'] === 'all')>Semua Status
                                    </option>
                                    <option value="Menunggu" @selected($reportFilters['status'] === 'Menunggu')>Menunggu
                                    </option>
                                    <option value="Diproses" @selected($reportFilters['status'] === 'Diproses')>Diproses
                                    </option>
                                    <option value="Selesai" @selected($reportFilters['status'] === 'Selesai')>Selesai
                                    </option>
                                    <option value="Dibatalkan" @selected($reportFilters['status'] === 'Dibatalkan')>
                                        Dibatalkan</option>
                                </select>
                            </div>
                            <div class="flex gap-2">
                                <button type="submit"
                                    class="rounded-xl bg-emerald-500 px-4 py-2 text-sm font-bold text-white">Apply</button>
                                <a href="{{ route('dashboard.admin', ['section' => 'laporan']) }}"
                                    class="rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-600">Reset</a>
                            </div>
                        </form>
                    </div>
                ...
                <div id="page-jadwal" class="page">
                    ...
                    @if (session('success'))
                        <div
                            class="mt-6 rounded-3xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm font-semibold text-emerald-700">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <section
                        class="mt-8 overflow-hidden rounded-[2rem] bg-white shadow-xl shadow-slate-200/60 ring-1 ring-slate-200">
                        <div
                            ...
                            <span
                                class="rounded-2xl bg-amber-100 px-4 py-2 text-sm font-black uppercase tracking-[0.1em] text-amber-600">{{ $stats['menunggu'] }}
                                Antrean</span>
                        </div>
                        ...
                        <div class="divide-y divide-slate-200">
                            @forelse ($pendingRequests as $index => $item)
                                <article class="grid gap-6 px-6 py-6 xl:grid-cols-[1.2fr,0.9fr] xl:items-center">
                                    <div>
                                        ...
                                        <p class="mt-3 text-lg text-slate-400">
                                            ...
                                            @foreach ($item->items as $detail)
                                                <span
                                                    class="font-semibold text-slate-500">{{ $detail->kategoriSampah?->nama }}</span>{{ $loop->last ? '' : ', ' }}
                                            @endforeach
                                    ...
                                    <form action="{{ route('dashboard.admin.schedule', $item) }}" method="POST"
                                        class="grid gap-3 md:grid-cols-[1.2fr,1fr,auto] md:items-end">
                                        @csrf
                                        <label class="block">
                                            <span
                                                class="mb-2 block text-sm font-black uppercase tracking-[0.2em] text-slate-400">Input
                                                Jadwal</span>
                                        ...
                                        <label class="block">
                                            <span
                                                class="mb-2 block text-sm font-black uppercase tracking-[0.2em] text-slate-400">Pilih
                                                Petugas</span>
                                        ...
                                        <button type="submit"
                                            class="rounded-2xl bg-emerald-500 px-6 py-3 text-lg font-bold text-white shadow-lg shadow-emerald-500/20">
                                            Jadwalkan
                                        </button>
                                    </form>
                                </article>
                            @empty
                                <div class="px-6 py-16 text-center text-slate-500">Tidak ada permintaan dengan status
                                    menunggu.</div>
                            @endforelse
                        </div>
                    </section>
                                ...
                                <tbody>
                                    @forelse ($permintaanForStatus as $item)
                                        ...
                                        ($item->status === 'Diproses' ? 'status-dijadwalkan' : 'status-selesai')
                                                                        ...
                                                                        <td>
                                                                            <button
                                                                                onclick="openUpdateStatusModal({{ $item->id }}, '{{ $item->status }}', '{{ $item->pengguna?->name }}', '{{ $item->alamat }}')"
                                                                                class="text-blue-500 hover:text-blue-700 text-sm font-semibold px-3 py-1 rounded border border-blue-200 hover:bg-blue-50 transition">
                                                                                Update Status
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center py-8 text-slate-500">Tidak ada permintaan
                                                penjemputan.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                    ...
                    <section
                        class="mt-8 rounded-[2rem] bg-white p-6 shadow-xl shadow-slate-200/60 ring-1 ring-slate-200">
                        <div class="flex items-center justify-between gap-4">
                                ...
                                <article class="rounded-3xl border border-slate-200 p-5">
                                    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        <div>
                                            ...
                                            <p class="mt-2 text-base text-slate-500">Petugas:
                                                {{ $item->petugas?->name ?? '-' }}</p>
                                            <p class="mt-2 text-base text-slate-500">Jadwal:
                                                {{ optional($item->scheduled_at ? \Illuminate\Support\Carbon::parse($item->scheduled_at) : null)?->translatedFormat('d M Y, H:i') ?? '-' }}
                                            </p>
                                        </div>
                                        <span
                                            class="inline-flex rounded-full bg-amber-100 px-3 py-1 text-sm font-bold text-amber-700">{{ $item->status }}</span>
                                    </div>
                                </article>
                            @empty
                                <div
                                    class="rounded-3xl border border-dashed border-slate-300 p-8 text-center text-slate-500 xl:col-span-2">
                    ...
                    <div class="section-card">
                        <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <span class="text-sm text-slate-500">Total:
                                {{ $permintaan->count() + $laporanSampahLiar->count() }} laporan</span>
                        </div>
                        <div class="grid gap-4 p-6 md:grid-cols-2">
                            ...
                            @else
                                @foreach($permintaan as $laporan)
                                    ...
                                    @endphp
                                    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm verifikasi-card"
                                        data-status="{{ $statusFilter }}" data-type="permintaan">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                            <div class="min-w-0">
                                                <div class="flex flex-wrap items-center gap-2 text-sm text-slate-500">
                                                    <span
                                                        class="inline-flex rounded-full bg-slate-100 px-3 py-1 font-semibold text-slate-700">No.
                                                        {{ $loop->iteration }}</span>
                                                    <span
                                                        class="inline-flex rounded-full bg-slate-100 px-3 py-1 font-semibold text-slate-700">Permintaan</span>
                                                    <span>ID: JOB-{{ str_pad($laporan->id, 3, '0', STR_PAD_LEFT) }}</span>
                                                </div>
                                                <p class="mt-3 text-lg font-black text-slate-900">
                                                    {{ $laporan->pengguna?->name ?? 'Pengguna Tidak Diketahui' }}</p>
                                                <p class="text-sm text-slate-500">
                                                    {{ $laporan->pengguna?->email ?? 'Email tidak tersedia' }}</p>
                                            </div>
                                            <span
                                                class="status-badge {{ $laporan->status === 'Menunggu' ? 'status-menunggu' : ($laporan->status === 'Selesai' ? 'status-selesai' : 'status-dibatalkan') }}">{{ $laporan->status }}</span>
                                        </div>
                                        ...
                                        <div class="mt-5 grid gap-3 sm:grid-cols-2">
                                            <div class="rounded-3xl bg-slate-50 p-4 text-sm text-slate-600">
                                                ...
                                                <p class="mt-2 text-sm text-slate-600">
                                                    {{ $laporan->alamat ?? 'Tidak ada deskripsi' }}</p>
                                            </div>
                                            <div class="rounded-3xl bg-slate-50 p-4 text-sm text-slate-600">
                                                <p class="font-semibold text-slate-800">Jadwal</p>
                                                <p class="mt-2 text-sm text-slate-600">
                                                    {{ $laporan->tanggal ?? 'Belum tersedia' }}</p>
                                            </div>
                                        </div>

                                        <div class="mt-5 flex flex-wrap gap-3 items-center">
                                            <a href="{{ route('admin.permintaan.show', $laporan) }}"
                                                class="rounded-2xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-100 transition">Detail</a>
                                            @if($laporan->status === 'Menunggu')
                                                <form method="POST" action="{{ route('admin.verifikasi-laporan', $laporan) }}"
                                                    style="display: inline;"
                                                    onsubmit="showVerifikasiSuccess('disetujui'); return true;">
                                                    @csrf
                                                    <input type="hidden" name="status" value="disetujui">
                                                    <button type="submit"
                                                        class="rounded-2xl bg-emerald-500 px-4 py-2 text-sm font-bold text-white hover:bg-emerald-600 transition">Setujui</button>
                                                </form>
                                                <form method="POST" action="{{ route('admin.verifikasi-laporan', $laporan) }}"
                                                    style="display: inline;"
                                                    onsubmit="showVerifikasiSuccess('ditolak'); return true;">
                                                    @csrf
                                                    <input type="hidden" name="status" value="ditolak">
                                                    <button type="submit"
                                                        class="rounded-2xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-100 transition">Tolak</button>
                                                </form>
                                            @else
                                                <div class="rounded-2xl bg-slate-100 px-4 py-2 text-sm text-slate-600">Status:
                                                    {{ $laporan->status }}</div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                @foreach($laporanSampahLiar as $laporan)
                                    ...
                                    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm verifikasi-card"
                                        data-status="{{ $statusFilter }}" data-type="sampah_liar">
                                        @if ($laporan->foto)
                                            <div class="mb-6 overflow-hidden rounded-3xl border border-slate-200 bg-slate-100">
                                                <img src="{{ asset('storage/' . $laporan->foto) }}"
                                                    alt="Foto laporan {{ $laporan->lokasi ?? 'sampah liar' }}"
                                        ...
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                            <div class="min-w-0">
                                                <div class="flex flex-wrap items-center gap-2 text-sm text-slate-500">
                                                    <span
                                                        ...
                                                        {{ $loop->iteration }}</span>
                                                    <span
                                                        class="inline-flex rounded-full bg-slate-100 px-3 py-1 font-semibold text-slate-700">Sampah
                                                        Liar</span>
                                            ...
                                            <span
                                                class="status-badge {{ $laporan->status === 'pending' ? 'status-menunggu' : ($laporan->status === 'diverifikasi' ? 'status-selesai' : 'status-dibatalkan') }}">
                                        ...
                                        <div class="mt-5 grid gap-3 sm:grid-cols-2">
                                            <div class="rounded-3xl bg-slate-50 p-4 text-sm text-slate-600">
                                                ...
                                                <p class="mt-2 text-sm text-slate-600">
                                                    {{ $laporan->lokasi ?? 'Tidak ada deskripsi' }}</p>
                                            </div>
                                            <div class="rounded-3xl bg-slate-50 p-4 text-sm text-slate-600">
                                        ...
                                        <div class="mt-5 flex flex-wrap gap-3 items-center">
                                            <a href="{{ route('admin.sampah-liar.show', $laporan) }}"
                                                class="rounded-2xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-100 transition">Detail</a>
                                            @if($laporan->status === 'pending')
                                                <form method="POST"
                                                    action="{{ route('admin.verifikasi-laporan-sampah-liar', $laporan) }}"
                                                    style="display: inline;"
                                                    onsubmit="showVerifikasiSuccess('disetujui'); return true;">
                                                    @csrf
                                                    <input type="hidden" name="status" value="disetujui">
                                            ...
                                            @else
                                                <div class="rounded-2xl bg-slate-100 px-4 py-2 text-sm text-slate-600">Status:
                                                    {{ $laporan->status === 'diverifikasi' ? 'Disetujui' : 'Ditolak' }}</div>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
                ...
                <div id="page-kategori" class="page">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <button onclick="openModal('modal-tambah-kategori')"
                            class="rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-bold text-white">+ Tambah
                            Kategori</button>
                    </div>
                            ...
                            <tbody>
                                @foreach(\App\Models\KategoriSampah::all() as $kategori)
                                    <tr class="cursor-pointer hover:bg-slate-50"
                                        onclick="toggleKategoriRow({{ $kategori->id }})">
                                        <td class="py-4 px-3">
                                            <div class="flex items-center justify-between gap-3">
                                                <span>{{ $kategori->nama }}</span>
                                                <span id="kategori-arrow-{{ $kategori->id }}"
                                        ...
                                        <td>
                                            <button
                                                onclick="event.stopPropagation(); editKategori({{ $kategori->id }}, @json($kategori->nama), @json($kategori->deskripsi), {{ $kategori->poin_per_kg }}, {{ $kategori->harga_per_kg }})"
                                                class="text-emerald-500 hover:text-emerald-700">Edit</button>
                                            <form method="POST" action="{{ route('admin.kategori.destroy', $kategori) }}"
                                                style="display: inline;"
                                                onsubmit="event.stopPropagation(); return confirm('Yakin hapus kategori ini?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                        ...
                                        <td colspan="5" class="px-4 py-4">
                                            <div class="grid gap-4 md:grid-cols-[2fr,1fr] items-center">
                                                ...
                                                <div class="flex flex-wrap gap-2 justify-end">
                                                    <button
                                                        onclick="event.stopPropagation(); editKategori({{ $kategori->id }}, @json($kategori->nama), @json($kategori->deskripsi), {{ $kategori->poin_per_kg }}, {{ $kategori->harga_per_kg }})"
                                                        class="rounded-xl border border-emerald-500 px-4 py-2 text-sm font-semibold text-emerald-600 hover:bg-emerald-50">Edit</button>
                                                    <form method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="rounded-xl border border-red-500 px-4 py-2 text-sm font-semibold text-red-600 hover:bg-red-50">Hapus</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <form method="POST" action="{{ route('admin.konfigurasi-poin.update') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="poin_minimal_tukar"
                                        value="{{ session('poin_minimal_tukar', 100) }}"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="bonus_poin_bulanan"
                                        value="{{ session('bonus_poin_bulanan', 50) }}"
                                        class="w-full border border-slate-300 rounded-lg px-3 py-2" required>
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold mb-2">Maksimal Poin Harian</label>
                                    <input type="number" name="maksimal_poin_harian"
                                        value="{{ session('maksimal_poin_harian', 200) }}"
                                        class="w-full border border-slate-300 rounded-lg px-3 py-2" required>
                                </div>
                            </div>
                            <button type="submit"
                                class="mt-4 rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-bold text-white">Simpan
                                Konfigurasi</button>
                        </form>
                    </div>
                </div>
                ...
                <div id="page-reward" class="page">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <button onclick="openModal('modal-tambah-reward')"
                            class="rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-bold text-white">+ Tambah
                            Reward</button>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="section-card p-5">
                            ...
                            <p class="text-2xl font-black text-slate-800">{{ $rewards->where('aktif', true)->count() }}
                            </p>
                        </div>
                        <div class="section-card p-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
                            @forelse($rewards as $reward)
                                <div class="rounded-2xl border border-slate-200 p-4 relative">
                                    ...
                                    <div class="flex items-start justify-between mb-2">
                                        ...
                                        <div class="flex gap-1">
                                            ...
                                            <form method="POST" action="{{ route('admin.reward.destroy', $reward) }}"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="text-slate-400 hover:text-red-600 text-sm">✕</button>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <span
                                            class="text-xs px-2 py-1 rounded-full {{ $reward->aktif ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700' }}">
                ...
                <div id="page-area" class="page">
                    ...
                    <div class="section-card mt-6">
                        <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
                            <div>
                                <h2 class="text-xl font-black text-slate-800">Usulan Titik Layanan Menunggu Verifikasi
                                </h2>
                                <p class="mt-1 text-sm text-slate-500">Usulan dari masyarakat akan tampil sebagai marker
                                    oranye di peta.</p>
                            </div>
                            <p class="text-sm font-semibold text-slate-500">{{ $usulanMenunggu->count() }} usulan
                                menunggu</p>
                        </div>
                                    ...
                                    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                        <div>
                                            <div class="flex flex-wrap items-center gap-2">
                                                <span
                                                    class="rounded-xl bg-amber-100 px-3 py-1 text-xs font-black uppercase tracking-[0.12em] text-amber-700">Diajukan</span>
                                                <span
                                                    class="rounded-xl bg-slate-200 px-3 py-1 text-xs font-semibold text-slate-700">
                                                    {{ $usulan->jenis_layanan === 'bank_sampah' ? 'Bank Sampah' : 'Titik Sampah' }}
                                                </span>
                                            </div>

                                            <p class="mt-3 text-lg font-bold text-slate-800">{{ $usulan->alamat_detail }}
                                            </p>
                                            <p class="mt-1 text-sm text-slate-600">Koordinat:
                                                {{ number_format($usulan->latitude, 6) }},
                                                {{ number_format($usulan->longitude, 6) }}</p>
                                            <p class="mt-2 text-sm text-slate-600">Alasan: {{ $usulan->deskripsi_alasan }}
                                            </p>
                                            <p class="mt-2 text-xs font-semibold uppercase tracking-[0.1em] text-slate-500">
                                                Pengusul: {{ $usulan->pengusul?->name ?? 'Pengguna' }} •
                                                {{ optional($usulan->created_at)->translatedFormat('d M Y H:i') }}
                                            </p>
                                        </div>

                                        <div class="flex w-full flex-col gap-2 sm:w-auto">
                                            <form method="POST"
                                                action="{{ route('dashboard.admin.usulan.approve', $usulan) }}">
                                                @csrf
                                                <button type="submit"
                                                    class="w-full rounded-xl bg-emerald-600 px-4 py-2 text-sm font-bold text-white transition hover:bg-emerald-700">
                                                    Setujui & Jadikan Titik Layanan
                                                </button>
                                            </form>

                                            <form method="POST"
                                                action="{{ route('dashboard.admin.usulan.reject', $usulan) }}"
                                                class="space-y-2">
                                                @csrf
                                                ...
                                                <button type="submit"
                                                    class="w-full rounded-xl border border-red-300 bg-red-50 px-4 py-2 text-sm font-bold text-red-700 transition hover:bg-red-100">
                                                    Tolak Usulan
                                                </button>
                                            </form>
                                        </div>
                    ...
                    <div class="section-card">
                        <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <button id="btn-open-titik-layanan-modal" onclick="openModal('modal-tambah-titik-layanan')"
                                class="rounded-2xl bg-emerald-500 px-4 py-2 text-sm font-bold text-white">+ Tambah Titik
                                Layanan</button>
                        </div>
                        <table>
                            <thead>
                            ...
                            <tbody>
                                @forelse($titikLayanan as $titik)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex gap-2">
                                                <button
                                                    onclick="editTitikLayanan({{ $titik->id }}, '{{ $titik->nama }}', '{{ $titik->jenis }}', '{{ $titik->alamat }}', '{{ $titik->jam_operasional }}', {{ $titik->latitude }}, {{ $titik->longitude }}, '{{ $titik->jenis_sampah_diterima }}')"
                                                    class="text-slate-400 hover:text-slate-600 text-sm">✎</button>
                                                <form method="POST"
                                                    action="{{ route('admin.titik-layanan.destroy', $titik) }}"
                                                    class="inline"
                                                    onsubmit="return confirm('Apakah Anda yakin ingin menghapus titik layanan ini?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="text-slate-400 hover:text-red-600 text-sm">✕</button>
                                                </form>
                                                <a href="{{ route('admin.jadwal.index', $titik->id) }}"
                                                    class="text-emerald-500 hover:text-emerald-700 text-sm font-semibold ml-2">🕒
                                                    Jadwal</a>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-8 text-slate-500">Belum ada titik layanan yang
                                            ditambahkan.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <div id="page-petugas" class="page">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <button onclick="openModal('modal-tambah-petugas')"
                            class="rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-bold text-white">+ Tambah
                            Petugas</button>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="section-card p-5">
                            ...
                            <p class="text-2xl font-black text-slate-800">
                                {{ $petugas->where('created_at', '>=', now()->startOfDay())->count() }}</p>
                        </div>
                        <div class="section-card p-5">
                            <p class="text-sm text-slate-500">Penjemputan Selesai</p>
                            <p class="text-2xl font-black text-slate-800">
                                {{ $permintaan->where('status', 'Selesai')->count() }}</p>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
                            @forelse($petugas as $petugasItem)
                                                    <div class="rounded-2xl border border-slate-200 p-5">
                                                        <div class="flex items-center justify-between mb-4">
                                                            <div class="flex items-center gap-4">
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="text-emerald-600 font-bold">{{ substr($petugasItem->name, 0, 1) }}</span>
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="flex gap-1">
                                                                <button
                                                                    onclick="editPetugas({{ $petugasItem->id }}, '{{ $petugasItem->name }}', '{{ $petugasItem->email }}')"
                                                                    class="text-slate-400 hover:text-slate-600 text-sm">✎</button>
                                                                <form method="POST" action="{{ route('admin.petugas.destroy', $petugasItem) }}"
                                                                    class="inline"
                                                        ...
                                                        <div class="space-y-1">
                                                            <p class="text-sm text-slate-600">Status: <span
                                                                    class="text-emerald-600 font-semibold">Aktif</span></p>
                                                            <p class="text-sm text-slate-600">Penjemputan hari ini:
                                                                {{ $permintaan->where('petugas_id', $petugasItem->id)->where('status', 'Selesai')->filter(function ($item) {
                                return $item->updated_at && $item->updated_at->isToday(); })->count() }}
                                                            </p>
                                                            <p class="text-sm text-slate-600">Total penjemputan:
                                                                {{ $permintaan->where('petugas_id', $petugasItem->id)->where('status', 'Selesai')->count() }}
                                                            </p>
                                                        </div>
                                                    </div>
                            @empty
                ...
                <div id="page-riwayat" class="page">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="flex gap-3">
                            <button type="button" onclick="exportServiceHistoryCsv()"
                                class="rounded-2xl border border-slate-300 px-4 py-2 text-sm font-semibold">Export
                                CSV</button>
                            <button type="button" onclick="filterServiceHistory()"
                                class="rounded-2xl bg-emerald-500 px-4 py-2 text-sm font-bold text-white">Filter</button>
                        </div>
                    </div>
                    ...
                    <div class="section-card">
                        ...
                        <table>
                            ...
                            <tbody>
                                @forelse($permintaan as $history)
                                    <tr class="history-row" data-date="{{ $history->created_at->format('Y-m-d') }}"
                                        data-status="{{ $history->status }}"
                                        data-petugas="{{ $history->petugas_id ?? 'none' }}">
                                        ...
                                        <td><span
                                                class="status-badge {{ $history->status === 'Menunggu' ? 'status-menunggu' : ($history->status === 'Selesai' ? 'status-selesai' : ($history->status === 'Diproses' ? 'status-dijadwalkan' : 'status-dibatalkan')) }}">{{ $history->status }}</span>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-6 text-slate-500">Belum ada riwayat layanan.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        <div class="px-6 py-4 border-t border-slate-100">
                            <p id="history-count" class="text-sm text-slate-500">Menampilkan {{ $permintaan->count() }}
                                dari {{ $permintaan->count() }} records</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="page-laporan" class="page">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="mt-1 text-slate-500">Generate and view periodic reports from pickup request data.
                            </p>
                        </div>
                        <div class="flex gap-3">
                            <button type="button" onclick="exportPeriodicReportCsv()"
                                class="rounded-2xl border border-slate-300 px-4 py-2 text-sm font-semibold">Export
                                CSV</button>
                            <button type="submit" form="periodic-report-filter"
                                class="rounded-2xl bg-emerald-500 px-4 py-2 text-sm font-bold text-white">Generate
                                Report</button>
                        </div>
                    </div>
                    ...
                    <!-- Date Filter -->
                    <div class="section-card mb-6 p-5">
                        <form id="periodic-report-filter" method="GET" action="{{ route('dashboard.admin') }}"
                            ...
                            <div>
                                ...
                                <select name="report_type" class="w-full border border-slate-300 rounded-lg px-3 py-2">
                                    <option value="monthly" @selected($reportFilters['type'] === 'monthly')>Bulanan
                                    </option>
                                    <option value="weekly" @selected($reportFilters['type'] === 'weekly')>Mingguan
                                    </option>
                            ...
                            <button type="submit"
                                class="rounded-2xl bg-emerald-500 px-4 py-2 text-sm font-bold text-white">Terapkan
                                Filter</button>
                        </form>
                    </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-4">
                            ...
                            <div class="text-center">
                                <p class="text-2xl font-black text-emerald-500">
                                    {{ number_format($periodicSummary['total_berat'], 2) }}</p>
                                <p class="text-sm text-slate-500">Total Sampah (kg)</p>
                            </div>
                            <div class="text-center">
                                <p class="text-2xl font-black text-emerald-500">{{ $periodicSummary['pengguna_unik'] }}
                                </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-slate-400">
                                                {{ $report->pengguna?->name ?? 'Pengguna Tidak Diketahui' }}</p>
                                        </td>
                                        <td>{{ number_format($report->items->sum('berat_kg'), 2) }}</td>
                                        <td><span
                                                class="status-badge {{ $report->status === 'Menunggu' ? 'status-menunggu' : ($report->status === 'Selesai' ? 'status-selesai' : ($report->status === 'Diproses' ? 'status-dijadwalkan' : 'status-dibatalkan')) }}">{{ $report->status }}</span>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center py-6 text-slate-500">Tidak ada laporan pada
                                            periode ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div id="modal-tambah-reward" class="modal-overlay" onclick="closeModalOutside(event,'modal-tambah-reward')">
            <div class="modal">
                ...
                <form id="reward-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Nama
                                Reward</label>
                            <input type="text" name="nama" id="reward-nama" placeholder="Contoh: Voucher Belanja"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Poin
                                Diperlukan</label>
                            <input type="number" name="poin_diperlukan" id="reward-poin" placeholder="Contoh: 100"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Stok</label>
                            <input type="number" name="stok" id="reward-stok" placeholder="Contoh: 50"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label
                    ...
                    <div class="mt-6 flex gap-3">
                        <button type="button" onclick="closeModal('modal-tambah-reward')"
                            class="flex-1 rounded-xl border border-slate-300 py-3 text-sm font-semibold text-slate-600">Batal</button>
                        <button type="submit"
                            class="flex-1 rounded-xl bg-emerald-500 py-3 text-sm font-bold text-white">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="modal-tambah-petugas" class="modal-overlay" onclick="closeModalOutside(event,'modal-tambah-petugas')">
            <div class="modal">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button onclick="closeModal('modal-tambah-petugas')"
                        class="text-slate-400 hover:text-slate-600 text-xl">✕</button>
                </div>
                <form id="petugas-form" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Nama
                                Lengkap</label>
                            <input type="text" name="name" id="petugas-nama" placeholder="Contoh: Ahmad Surya"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Email</label>
                            <input type="email" name="email" id="petugas-email" placeholder="Contoh: ahmad@siresik.com"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Password</label>
                            <input type="password" name="password" id="petugas-password"
                                placeholder="Minimal 8 karakter"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Konfirmasi
                                Password</label>
                            <input type="password" name="password_confirmation" id="petugas-password-confirm"
                                placeholder="Ulangi password"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                    </div>
                    <div class="mt-6 flex gap-3">
                        <button type="button" onclick="closeModal('modal-tambah-petugas')"
                            class="flex-1 rounded-xl border border-slate-300 py-3 text-sm font-semibold text-slate-600">Batal</button>
                        <button type="submit"
                            class="flex-1 rounded-xl bg-emerald-500 py-3 text-sm font-bold text-white">Simpan</button>
                    </div>
        ...
        <div id="modal-tambah-titik-layanan" class="modal-overlay"
            onclick="closeModalOutside(event,'modal-tambah-titik-layanan')">
            <div class="modal">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-xl font-black text-slate-800" id="modal-titik-layanan-title">Tambah Titik Layanan
                    </h3>
                    <button onclick="closeModal('modal-tambah-titik-layanan')"
                        class="text-slate-400 hover:text-slate-600 text-xl">✕</button>
                </div>
                <form id="titik-layanan-form" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Nama
                                Titik Layanan</label>
                            <input type="text" name="nama" id="titik-layanan-nama" placeholder="Contoh: TPS Margonda"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Jenis</label>
                            <select name="jenis" id="titik-layanan-jenis"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        ...
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Alamat</label>
                            <textarea name="alamat" id="titik-layanan-alamat" rows="2"
                        ...
                        <div>
                            ...
                            <div id="titik-layanan-map"
                                class="h-[220px] overflow-hidden rounded-xl border border-slate-200 bg-slate-50"></div>
                            <p id="titik-layanan-koordinat" class="mt-2 text-xs text-slate-500">Klik peta untuk
                                menentukan titik layanan.</p>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Latitude</label>
                                <input type="text" id="titik-layanan-latitude-display"
                                    class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm bg-slate-50"
                                    readonly>
                                <input type="hidden" name="latitude" id="titik-layanan-latitude" required>
                            </div>
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Longitude</label>
                                <input type="text" id="titik-layanan-longitude-display"
                                    class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm bg-slate-50"
                                    readonly>
                        ...
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Jam
                                Operasional</label>
                            <input type="text" name="jam_operasional" id="titik-layanan-jam"
                                placeholder="Contoh: 08:00 - 17:00 (opsional)"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm">
                        </div>
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Jenis
                                Sampah Diterima</label>
                            <input type="text" name="jenis_sampah_diterima" id="titik-layanan-sampah"
                                placeholder="Contoh: Plastik, Organik, Kertas (opsional)"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm">
                        </div>
                    </div>
                    <div class="mt-6 flex gap-3">
                        <button type="button" onclick="closeModal('modal-tambah-titik-layanan')"
                            class="flex-1 rounded-xl border border-slate-300 py-3 text-sm font-semibold text-slate-600">Batal</button>
                        <button type="submit"
                            class="flex-1 rounded-xl bg-emerald-500 py-3 text-sm font-bold text-white">Simpan</button>
                    </div>
        ...
        <div id="modalTambahArea" class="modal-overlay" onclick="closeModalOutside(event,'modalTambahArea')">
            <div class="modal" style="width: 920px; max-width: 92vw;">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button type="button" onclick="closeModal('modalTambahArea')"
                        class="text-slate-400 hover:text-slate-600 text-xl">✕</button>
                </div>
                <form id="formTambahArea" method="POST" action="{{ route('admin.zona-layanan.store') }}">
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[360px,1fr]">
                        <div class="space-y-4">
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Nama
                                    Zona</label>
                                <input type="text" name="nama" value="{{ old('nama') }}"
                                    placeholder="Contoh: Zona A - Gedung Kuliah"
                                    class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                            </div>
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Warna
                                    Zona</label>
                                <div class="flex items-center gap-3 border border-slate-200 rounded-xl px-3 py-2">
                                    <input type="color" id="zona-warna" name="warna"
                                        value="{{ old('warna', '#16a34a') }}"
                                        class="h-10 w-14 rounded-lg border border-slate-200 bg-white p-1">
                                    <input type="text" id="zona-warna-text" value="{{ old('warna', '#16a34a') }}"
                                        readonly
                                        class="flex-1 border border-slate-200 rounded-lg px-3 py-2 text-sm bg-slate-50 font-semibold text-slate-700">
                                </div>
                            </div>
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Cakupan
                                    Wilayah (Radius)</label>
                                <input type="number" id="zona-radius-km" inputmode="decimal" step="0.1" min="0.1"
                                    placeholder="Radius (km). Contoh: 1.0"
                                    class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm">
                                <div class="mt-3 flex flex-wrap gap-2">
                                    <button type="button"
                                        class="zona-radius-preset px-3 py-2 border border-slate-200 rounded-lg text-xs font-bold text-slate-700"
                                        data-km="0.25">0.25 km</button>
                                    <button type="button"
                                        class="zona-radius-preset px-3 py-2 border border-slate-200 rounded-lg text-xs font-bold text-slate-700"
                                        data-km="0.5">0.5 km</button>
                                    <button type="button"
                                        class="zona-radius-preset px-3 py-2 border border-slate-200 rounded-lg text-xs font-bold text-slate-700"
                                        data-km="1">1 km</button>
                                    <button type="button"
                                        class="zona-radius-preset px-3 py-2 border border-slate-200 rounded-lg text-xs font-bold text-slate-700"
                                        data-km="2">2 km</button>
                                    <button type="button"
                                        class="zona-radius-preset px-3 py-2 border border-slate-200 rounded-lg text-xs font-bold text-slate-700"
                                        data-km="5">5 km</button>
                                </div>
                                <p class="mt-3 text-xs text-slate-500">Klik peta untuk menentukan titik pusat. Area akan
                                    terbentuk berdasarkan radius.</p>
                            </div>
                            ...
                            <div class="mt-6 flex gap-3">
                                <button type="button" onclick="closeModal('modalTambahArea')"
                                    class="flex-1 rounded-xl border border-slate-300 py-3 text-sm font-semibold text-slate-600">Batal</button>
                                <button type="submit"
                                    class="flex-1 rounded-xl bg-emerald-500 py-3 text-sm font-bold text-white">Simpan
                                    Area</button>
                            </div>
                        </div>
        ...
        <div id="modal-tambah-kategori" class="modal-overlay"
            onclick="closeModalOutside(event,'modal-tambah-kategori')">
            <div class="modal">
                <div class="flex items-center justify-between mb-6">
                ...
                <form id="kategori-form" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Nama
                                Kategori</label>
                            <input type="text" name="nama" id="kategori-nama" placeholder="Contoh: Plastik"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Poin
                                    per kg</label>
                                <input type="number" name="poin_per_kg" id="kategori-poin" placeholder="Contoh: 50"
                                    class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                            </div>
                            <div>
                                <label
                                    class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Harga
                                    per kg (Rp)</label>
                                <input type="number" name="harga_per_kg" id="kategori-harga" placeholder="Contoh: 5000"
                                    class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                            </div>
                        </div>
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Deskripsi</label>
                            <textarea name="deskripsi" id="kategori-deskripsi" rows="3"
        ...
        <div id="modal-tambah-jadwal-area" class="modal-overlay"
            ...
            <div class="modal">
                ...
                <form id="jadwal-area-form" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Hari</label>
                            <select name="hari" id="jadwal-hari"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        ...
                        <div>
                            <label
                                class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Zona/Area</label>
                            <input type="text" name="zona" id="jadwal-zona" placeholder="Contoh: Zona A"
                                class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm" required>
                        </div>
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Jam
                    ...
                    <div class="mt-6 flex gap-3">
                        <button type="button" onclick="closeModal('modal-tambah-jadwal-area')"
                            class="flex-1 rounded-xl border border-slate-300 py-3 text-sm font-semibold text-slate-600">Batal</button>
                        <button type="submit"
                            class="flex-1 rounded-xl bg-emerald-500 py-3 text-sm font-bold text-white">Simpan</button>
                    </div>
        ...
        <div id="modal-verifikasi-result" class="modal-overlay"
            onclick="closeModalOutside(event,'modal-verifikasi-result')">
            <div class="modal" style="max-width: 400px;">
                <div class="text-center">
                    ...
                    <p class="text-slate-500 mb-6" id="verifikasi-message">Laporan telah berhasil disetujui dan diterima
                        oleh sistem.</p>
                    <button onclick="closeModal('modal-verifikasi-result'); location.reload();"
                        class="w-full rounded-xl bg-emerald-500 py-3 text-sm font-bold text-white">Selesai</button>
                </div>
            </div>
        </div>
        ...
        <div id="modal-update-status" class="modal-overlay" onclick="closeModalOutside(event,'modal-update-status')">
            <div class="modal" style="max-width: 500px;">
                ...
                <form id="update-status-form" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Status
                                Baru</label>
                    ...
                    <div class="mt-6 flex gap-3">
                        <button type="button" onclick="closeModal('modal-update-status')"
                            class="flex-1 rounded-xl border border-slate-300 py-3 text-sm font-semibold text-slate-600">Batal</button>
                        <button type="submit"
                            class="flex-1 rounded-xl bg-blue-500 py-3 text-sm font-bold text-white hover:bg-blue-600 transition">Update
                            Status</button>
                    </div>
                </form>
            </div>
