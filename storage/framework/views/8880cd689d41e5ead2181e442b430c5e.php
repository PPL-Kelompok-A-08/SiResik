        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 transition">
            ...
            <div class="space-y-4">
                <?php if($notifications->count() > 0): ?>
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($notification->type === 'App\Notifications\ServiceStatusChanged'): ?>
                            <div class="bg-white rounded-lg shadow-sm border-l-4 <?php echo e(is_null($notification->read_at) ? 'border-blue-500 bg-blue-50' : 'border-slate-300'); ?> p-6">
                                <div class="flex gap-4">
                                    <div class="flex-shrink-0">
                                        <div class="flex items-center justify-center h-12 w-12 rounded-full <?php echo e(is_null($notification->read_at) ? 'bg-blue-100' : 'bg-slate-100'); ?>">
                                            <svg class="w-6 h-6 <?php echo e(is_null($notification->read_at) ? 'text-blue-600' : 'text-slate-400'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <div class="flex items-start justify-between">
                                            <div>
                                                ...
                                                <p class="mt-2 text-slate-700">
                                                    <strong>Alamat:</strong> <?php echo e($notification->data['alamat'] ?? 'N/A'); ?>

                                                </p>
                                                <p class="mt-2 text-slate-700">
                                                    <strong>Tanggal:</strong> <?php echo e($notification->data['tanggal'] ?? 'N/A'); ?><br>
                                                    <strong>Jadwal:</strong> <?php echo e($notification->data['jadwal'] ?? 'N/A'); ?>

                                                </p>
                                                <div class="mt-3 inline-flex items-center gap-2">
                                                    <span class="px-3 py-1 bg-amber-100 text-amber-800 text-sm font-semibold rounded-full">
                                                        <?php echo e($notification->data['old_status'] ?? 'N/A'); ?>
                                                    ...
                                                    <span class="px-3 py-1 bg-green-100 text-green-800 text-sm font-semibold rounded-full">
                                                        <?php echo e($notification->data['new_status'] ?? 'N/A'); ?>

                                                    </span>
                                                </div>
                                                <p class="mt-3 text-sm text-slate-500">
                                                    <?php echo e($notification->created_at->format('d F Y H:i')); ?> (<?php echo e($notification->created_at->diffForHumans()); ?>)
                                                </p>
                                            </div>
...
<?php /**PATH C:\Users\Raffi\Documents\GitHub\SiResik\resources\views/notifications/index.blade.php ENDPATH**/ ?>