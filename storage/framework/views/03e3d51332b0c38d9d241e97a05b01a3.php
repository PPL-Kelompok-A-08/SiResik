    ...
    <div class="grid grid-cols-1 lg:grid-cols-[280px,1fr]">
        <aside class="border-b border-slate-200 bg-white px-5 py-5 lg:border-b-0 lg:border-r">
            ...
            <div id="zona-list" class="mt-4 space-y-2">
                <?php $__empty_1 = true; $__currentLoopData = ($zonaLayanan ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $z): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-stretch gap-2">
                        <button type="button"
                            ...
                            data-zona-id="<?php echo e($z->id); ?>"
                            data-zona-nama="<?php echo e($z->nama); ?>"
                            data-zona-warna="<?php echo e($z->warna); ?>"
                            data-zona-update="<?php echo e(route('admin.zona-layanan.update', $z)); ?>">
                            <span class="flex items-center gap-3">
                                <span class="h-4 w-4 rounded-full" style="background: <?php echo e($z->warna); ?>"></span>
                                <span class="font-bold text-slate-800"><?php echo e($z->nama); ?></span>
                            </span>
                            <span class="zona-count rounded-xl bg-slate-100 px-2.5 py-1 text-xs font-bold text-slate-600" data-count-for="<?php echo e($z->id); ?>">0</span>
                        </button>
                        ...
                        <form method="POST" action="<?php echo e(route('admin.zona-layanan.destroy', $z)); ?>"
...
(function () {
    ...
    const usulanData = <?php echo json_encode($usulanMenunggu ?? [], 15, 512) ?>;
    const zonaData = <?php echo json_encode($zonaLayanan ?? [], 15, 512) ?>;
...
<?php /**PATH D:\File Kuliah\Semester 6\Proyek Perangkat Lunak\SiResik\resources\views/peta/_leaflet-area-admin-map.blade.php ENDPATH**/ ?>