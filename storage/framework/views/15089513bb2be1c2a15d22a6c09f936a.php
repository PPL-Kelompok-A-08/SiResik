...
<div class="row">
    <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4">
            <div class="card mb-3 kategori-card" data-id="<?php echo e($item->id); ?>">
                <div class="card-body">
                    <h5><?php echo e($item->nama); ?></h5>
                    <p><?php echo e($item->deskripsi); ?></p>
                    <p><strong><?php echo e($item->poin_per_kg); ?> poin/kg</strong></p>

                    <button class="btn btn-primary btn-detail" data-id="<?php echo e($item->id); ?>">
                        Pilih
                    </button>
                </div>
            </div>
...
</html><?php /**PATH D:\File Kuliah\Semester 6\Proyek Perangkat Lunak\SiResik\resources\views/kategori/index.blade.php ENDPATH**/ ?>