                            ...
                            <div class="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                                <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="kategori-card group block cursor-pointer rounded-3xl border border-slate-200 bg-white p-5 transition hover:border-emerald-300 hover:shadow-lg"
                                        ...
                                        data-harga="<?php echo e($item->harga_per_kg); ?>">
                                        ...
                                        <div class="flex h-full flex-col">
                                            <div class="flex items-start justify-between gap-4">
                                                ...
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <span class="rounded-full bg-rose-50 px-3 py-1 text-xs font-bold text-rose-700">Rp <?php echo e(number_format($item->harga_per_kg, 0, ',', '.')); ?>/kg</span>
                                                </div>
                                            </div>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__empty_1 = true; $__currentLoopData = $permintaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="align-top">
                                ...
                                <td class="py-4 pr-4 font-bold text-rose-600">Rp <?php echo e(number_format($item->total_tagihan, 0, ',', '.')); ?></td>
                                <td class="py-4">
                                    <?php
...
<?php /**PATH /Users/mac/Downloads/SiResik/resources/views/permintaan-penjemputan/index.blade.php ENDPATH**/ ?>