                    ...
                    <div class="flex flex-col gap-3">
                        <?php $__empty_1 = true; $__currentLoopData = $trackingRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <article class="flex items-center gap-4 rounded-2xl bg-white px-5 py-4 shadow-sm ring-1 ring-slate-200 transition hover:shadow-md">
                                ...
                                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full <?php echo e($statusMeta['iconBg']); ?> text-xl font-black <?php echo e($statusMeta['iconText']); ?>">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <span class="text-xs font-black text-slate-400"><?php echo e($pkId); ?></span>
                                        <span class="rounded-md px-2 py-0.5 text-[10px] font-black <?php echo e($statusMeta['badge']); ?>">
                                            <?php echo e($statusMeta['label']); ?>

                                        </span>
                                    </div>
                                    <p class="mt-1 text-base font-black text-slate-800">
                                        <?php echo e($kategoriText ?: 'Permintaan Penjemputan'); ?>

                                    </p>
                                    <p class="mt-0.5 text-xs text-slate-400">
                                        Diajukan pada <?php echo e(optional($item->created_at)->translatedFormat('d M Y')); ?>

                                        &bull; Estimasi berat <?php echo e($beratLabel); ?> kg
                                    </p>
                                    <?php if($item->status === 'Diproses' && $item->scheduled_at): ?>
                                        <p class="mt-0.5 text-xs font-semibold text-blue-600">
                                            Dijadwalkan <?php echo e(\Illuminate\Support\Carbon::parse($item->scheduled_at)->translatedFormat('d M Y, H:i')); ?> WIB
                                            <?php echo e($item->petugas ? '• ' . $item->petugas->name : ''); ?>
                        ...
                        <?php $__currentLoopData = $weeklySchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="px-5 py-4">
                                <div class="flex items-center justify-between">
                                    <p class="text-sm font-black uppercase tracking-wide text-[#0c5b49]"><?php echo e($schedule['hari']); ?></p>
                                    <span class="rounded-lg bg-slate-100 px-2.5 py-1 text-[10px] font-black text-slate-500"><?php echo e($schedule['jam']); ?></span>
                                </div>
                                <p class="mt-2 text-sm font-bold text-slate-800"><?php echo e($schedule['kategori']); ?></p>
                                <p class="mt-0.5 text-xs italic text-slate-400">Berlaku untuk <?php echo e($schedule['zona']); ?></p>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php /**PATH C:\Users\Raffi\Documents\GitHub\SiResik\resources\views/status-layanan/index.blade.php ENDPATH**/ ?>