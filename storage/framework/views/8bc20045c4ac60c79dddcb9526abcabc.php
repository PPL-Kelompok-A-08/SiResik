<aside class="bg-[#0c5b49] px-6 py-8 text-white">
    ...
    <nav class="mt-10 space-y-2">
        <?php if(auth()->user()->role === 'admin'): ?>
            ...
            <a href="<?php echo e(route('dashboard.admin')); ?>"
                class="flex items-center gap-4 rounded-2xl px-5 py-4 text-lg transition <?php echo e(request()->routeIs('dashboard.admin') ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-900/20' : 'text-emerald-50 hover:bg-white/5'); ?> cursor-pointer">
                <span class="text-xl"><?php echo e(request()->routeIs('dashboard.admin') ? '▣' : '◦'); ?></span>
            ...
            <a href="<?php echo e(route('notifications.index')); ?>"
                ...
                <?php if($unread > 0): ?>
                    <span class="ml-auto inline-flex items-center justify-center px-2 py-1 text-xs font-bold text-white bg-red-500 rounded-full"><?php echo e($unread); ?></span>
                <?php endif; ?>
            </a>
        <?php elseif(auth()->user()->role === 'petugas'): ?>
            <!-- Menu Petugas -->
            <a href="<?php echo e(route('dashboard.petugas')); ?>"
                class="flex items-center gap-4 rounded-2xl px-5 py-4 text-lg transition <?php echo e(request()->routeIs('dashboard.petugas') ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-900/20' : 'text-emerald-50 hover:bg-white/5'); ?> cursor-pointer">
                <span class="text-xl"><?php echo e(request()->routeIs('dashboard.petugas') ? '▣' : '◦'); ?></span>
            ...
            <a href="<?php echo e(route('petugas.riwayat')); ?>"
                class="flex items-center gap-4 rounded-2xl px-5 py-4 text-lg transition text-emerald-50 hover:bg-white/5">
                <span class="text-xl">◦</span>
        ...
        <?php else: ?>
            <!-- Menu Masyarakat -->
            <a href="<?php echo e(route('dashboard.masyarakat')); ?>"
                class="flex items-center gap-4 rounded-2xl px-5 py-4 text-lg transition <?php echo e(request()->routeIs('dashboard.masyarakat') ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-900/20' : 'text-emerald-50 hover:bg-white/5'); ?> cursor-pointer">
                <span class="text-xl"><?php echo e(request()->routeIs('dashboard.masyarakat') ? '▣' : '◦'); ?></span>
                <span>Dashboard</span>
            </a>
            <a href="<?php echo e(route('permintaan-penjemputan.index')); ?>"
                class="flex items-center gap-4 rounded-2xl px-5 py-4 text-lg transition text-emerald-50 hover:bg-white/5">
            ...
            <a href="<?php echo e(route('poin.index')); ?>"
                class="flex items-center gap-4 rounded-2xl px-5 py-4 text-lg transition text-emerald-50 hover:bg-white/5">
                <span class="text-xl">◦</span>
            ...
            <a href="<?php echo e(route('peta.usulan-titik')); ?>"
                class="flex items-center gap-4 rounded-2xl px-5 py-4 text-lg transition text-emerald-50 hover:bg-white/5">
                <span class="text-xl">◦</span>
    ...
    <div class="mt-10 rounded-3xl bg-white/5 px-4 py-5">
        <div class="flex items-center gap-4">
            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-500 text-xl font-black"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></div>
            <div>
                <p class="text-xl font-bold"><?php echo e(auth()->user()->name); ?></p>
...
<?php /**PATH C:\Users\Raffi\Documents\GitHub\SiResik\resources\views/components/sidebar.blade.php ENDPATH**/ ?>