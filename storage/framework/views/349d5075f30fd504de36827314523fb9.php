    ...
    <header class="bg-slate-950 text-white">
        <div class="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="<?php echo e(route('petugas.riwayat')); ?>" class="rounded-full border border-amber-300 px-5 py-3 text-sm font-bold text-amber-300 hover:bg-amber-300 hover:text-slate-950 transition">📋 Riwayat Tugas</a>
...
<?php /**PATH C:\Users\Raffi\Documents\GitHub\SiResik\resources\views/dashboard/petugas.blade.php ENDPATH**/ ?>